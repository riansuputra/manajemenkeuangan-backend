  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
      <td align="center" bgcolor="#ffffff">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px 10px;">
              <a href="https://www.blogdesire.com" target="_blank" style="display: inline-block;">
                <img src="https://i.postimg.cc/DwFFW5yz/testdfsdf.png" alt="Logo" border="0" width="48" style="display: block; width: 200px; max-width: 200px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td align="center" bgcolor="#ffffff" style="padding: 24px;">
        ...
        <td align="center" valign="top" width="600">
        <![endif]-->
        <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; border-top-style:solid;border-top-color:#ebeaef;"> 
